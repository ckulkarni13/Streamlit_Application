# -*- coding: utf-8 -*-
"""Copy of AsteroidPrediction.ipynb
...
# dump(rf_model, 'RandomForest_final.pkl')

df_outliers_rem.head()

df_outliers_rem.columns

numeric_columns = ['Absolute Magnitude', 'Est Dia in Miles(max)', 'Miles per hour',
...
# Group by 'Hazardous' column and calculate the range for each numeric column
ranges = df.groupby('Hazardous')[numeric_columns].agg(['min', 'max'])

# Print the range for each column
for column in numeric_columns:
    print(f"Range of {column}:")
    print("  Non-Hazardous:")
    print("    Min:", ranges[column]['min'][0])
    print("    Max:", ranges[column]['max'][0])
    print("  Hazardous:")
    print("    Min:", ranges[column]['min'][1])
    print("    Max:", ranges[column]['max'][1])
    print()
